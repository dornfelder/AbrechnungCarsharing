...
\setkomavar{signature}{\includegraphics[height=2cm]{signature}\\Alexandra Seregely} % Your name used in the signature
...
\date{5. August 2017} % Date of the letter
...
%	LETTER CONTENT
%----------------------------------------------------------------------------------------
\setkomavar{subject}{\bf{Monatsabrechnung April 2017}}
